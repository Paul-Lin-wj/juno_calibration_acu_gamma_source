...
def K40_calculate_components(dict_result, bins_center, dict_bkg, bins_fit):
...
class K40Fitter:
    def __init__(
        ...
        bkg_path: str = f"{PROJECT_ROOT}/K40_Compton_BKG.npz",
        x_limit: float = 0.6,
        if_fix_abc: bool = True,
        enable_c14: bool = True,
        fix_c14_amplitude: bool = False,
    ):
        self.MC_Qedep_Center = 1.3550554274479678
    ...
    def _organize_component(self):
        ...
        # 计算所有成分
        components = K40_calculate_components(
...
def K40FitterRunner(
    ...
    if_show_ylog=True,
    xlimit: float = 0.3,
    bkg_path: str = "K40_Compton_BKG.npz",
):
    """运行K40拟合器"""
    energy_fitter = K40Fitter(
        bins_fit=bins_fit,
...
def K40_plot_results_with_residuals(
    EnergyFitclss: object,
    title_latex: str,
    fig_path: str,
    ylabel_show: str,
