...
def Mn54_calculate_components(dict_result, bins_center, dict_bkg, bins_fit):
...
class Mn54Fitter:
    def __init__(
        ...
        bkg_path: str = f"{PROJECT_ROOT}/Mn54_Compton_BKG.npz",
        x_limit: float = 0.3,
        if_fix_abc: bool = True,
        enable_c14: bool = True,
        fix_c14_amplitude: bool = False,
    ):
        self.MC_Qedep_Center = 0.7506673749012558
    ...
    def _organize_component(self):
        ...
        # 计算所有成分
        components = Mn54_calculate_components(
...
def Mn54FitterRunner(
    ...
    if_show_ylog=True,
    xlimit: float = 0.3,
    bkg_path: str = "Mn54_Compton_BKG.npz",
):
    """运行Mn54拟合器"""
    energy_fitter = Mn54Fitter(
        bins_fit=bins_fit,
...
def Mn54_plot_results_with_residuals(
    EnergyFitclss: object,
    title_latex: str,
    fig_path: str,
    ylabel_show: str,
